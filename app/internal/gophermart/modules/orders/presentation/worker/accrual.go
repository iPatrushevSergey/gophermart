...
func NewAccrualWorker(useCases factory.UseCaseFactory, log port.Logger, pollInterval time.Duration) *AccrualWorker {
	return &AccrualWorker{
		processAccrual: useCases.ProcessAccrualUseCase(),
		log:            log,

...
// BalanceAccountWriter provides write access to balance accounts for balance module.
...
// BalanceAccountRepository combines reader and writer for balance DI wiring.

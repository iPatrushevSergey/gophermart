...
import (
	...
	"gophermart/internal/gophermart/modules/balance/adapters/repository/postgres/converter"
...
func NewBalanceAccountRepository(transactor *postgreskit.Transactor) *BalanceAccountRepository {

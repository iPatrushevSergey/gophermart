...
// Source: internal/gophermart/application/port/logger.go
//
// Generated by this command:
//
//	mockgen -source=internal/gophermart/application/port/logger.go -destination=internal/gophermart/application/port/mocks/mock_logger.go -package=mocks
//
